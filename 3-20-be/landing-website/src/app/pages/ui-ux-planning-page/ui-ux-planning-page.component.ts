...
import { UiUxPlanningService } from '../../services/ui-ux-planning.service';
...
@Component({
  selector: 'app-ui-ux-planning-page',
  standalone: true,
  ...
  templateUrl: './ui-ux-planning-page.component.html',
})
export class UiUxPlanningPageComponent {

  constructor(public us: UiUxPlanningService) { };
}
