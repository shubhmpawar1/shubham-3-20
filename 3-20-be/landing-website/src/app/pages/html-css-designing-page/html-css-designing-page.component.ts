...
import { HtmlCssDesigningService } from '../../services/html-css-designing.service';
...
@Component({
  selector: 'app-html-css-designing-page',
  standalone: true,
  imports: [HeaderComponent, HeroSectionComponent, TestimonialsComponent, CompaniesComponent, AdvancedCurriculumComponent, BenefitsBeyondLearningComponent, MeetYourMentorsSectionComponent, WhatYouThinkYouNeedVsWhatYouActuallyNeedComponent, AboutUsComponent, FooterComponent, FrequentlyAskedQuestionsComponent],
  templateUrl: './html-css-designing-page.component.html',
})
export class HtmlCssDesigningPageComponent {

  constructor(public hcds: HtmlCssDesigningService) { }
}
