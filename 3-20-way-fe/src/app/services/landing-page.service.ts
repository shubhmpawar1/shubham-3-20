...
export class LandingPageService {
  ...
  landing_page_content = {
    ...
    getting_started: {
      ...
      // SECTION 2 — FEES 
      fees_headline: 'Fees',
      fees_stack_intro: "Try it for free! We're keeping it simple for you - start your free, no-risk 10 day trial today, with a daily movement routine completely tailored to you. You will get full access to all features, and we won't ask for any payment details during your trial period.",
      fees_body: "The 3-20 Way is meant to be easy - and that includes the price! We have two simple price tiers, giving you the flexibility to choose a subscription that suits you:",
      fees_tiers: [
        {
        ...
        },
        {
          ...
          price: '£11.95',
          period: '/month',
          note: 'total cost of £143.40 per year',
          cta: { text: 'Start Now', link: '#' },
        },
        {
          name: 'Pay Annual',
          ...
          price: '£8.95',
          period: '/month',
          note: '£107.40 per year, a saving of £36.00',
          cta: { text: 'Start Now', link: '#' },
        },
      ],
      no_risk: "No Risk: we're keeping it simple for you - if at the end of your free trial The 3-20 Way is not for you, you can cancel and will not be charged.",
      cta_2: {
        text: 'Start Now',
        link: '#',
      },
    ...
    movement_cta: {
      img: 'assets/Open Folder ICON.png',
      title: 'With hundreds of easy to follow movement moments, small daily wins add up to big changes.',
      description: [
        'The 3-20 Way has been created by experienced movement coaches to provide older adults with a simple set of',
        'personalised daily movements. To improve mobility and strength from the comfort of home. From just 3 minutes of',
        'movement each day, Together we can change the story of how we age.',
      ],
    },
