...
export class LandingPageService {
      ...
      features: [
        {
          ...
          icon: `<svg viewBox="0 0 20 20" fill="currentColor" class="absolute top-1 left-1 size-5 text-orange-400"><path d="M5.5 17a4.5 4.5 0 0 1-1.44-8.765 4.5 4.5 0 0 1 8.302-3.046 3.5 3.5 0 0 1 4.504 4.272A4 4 0 0 1 15 17H5.5Zm3.75-2.75a.75.75 0 0 0 1.5 0V9.66l1.95 2.1a.75.75 0 1 0 1.1-1.02l-3.25-3.5a.75.75 0 0 0-1.1 0l-3.25 3.5a.75.75 0 1 0 1.1 1.02l1.95-2.1v4.59Z" clip-rule="evenodd" fill-rule="evenodd" /></svg>`
        },
        {
          title: 'Stream anywhere.',
          description: 'Watch on your laptop, tablet, or phone—at home or on the go.',
          icon: `<svg viewBox="0 0 20 20" fill="currentColor" class="absolute top-1 left-1 size-5 text-orange-400"><path d="M10 1a4.5 4.5 0 0 0-4.5 4.5V9H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-.5V5.5A4.5 4.5 0 0 0 10 1Zm3 8V5.5a3 3 0 1 0-6 0V9h6Z" clip-rule="evenodd" fill-rule="evenodd" /></svg>`
        },
        {
          title: 'Move anywhere.',
          description: 'Exercise at home, on holiday, or wherever suits your day.',
          icon: `<svg viewBox="0 0 20 20" fill="currentColor" class="absolute top-1 left-1 size-5 text-orange-400"><path d="M15.312 11.424a5.5 5.5 0 0 1-9.201 2.466l-.312-.311h2.433a.75.75 0 0 0 0-1.5H3.989a.75.75 0 0 0-.75.75v4.242a.75.75 0 0 0 1.5 0v-2.43l.31.31a7 7 0 0 0 11.712-3.138.75.75 0 0 0-1.449-.39Zm1.23-3.723a.75.75 0 0 0 .219-.53V2.929a.75.75 0 0 0-1.5 0V5.36l-.31-.31A7 7 0 0 0 3.239 8.188a.75.75 0 1 0 1.448.389A5.5 5.5 0 0 1 13.89 6.11l.311.31h-2.432a.75.75 0 0 0 0 1.5h4.243a.75.75 0 0 0 .53-.219Z" clip-rule="evenodd" fill-rule="evenodd" /></svg>`
        },
        {
          title: 'No equipment needed.',
          description: 'Start instantly without special gear or clothing.',
          icon: `<svg viewBox="0 0 20 20" fill="currentColor" class="absolute top-1 left-1 size-5 text-orange-400"><path d="M10 2.5c-1.31 0-2.526.386-3.546 1.051a.75.75 0 0 1-.82-1.256A8 8 0 0 1 18 9a22.47 22.47 0 0 1-1.228 7.351.75.75 0 1 1-1.417-.49A20.97 20.97 0 0 0 16.5 9 6.5 6.5 0 0 0 10 2.5ZM4.333 4.416a.75.75 0 0 1 .218 1.038A6.466 6.466 0 0 0 3.5 9a7.966 7.966 0 0 1-1.293 4.362.75.75 0 0 1-1.257-.819A6.466 6.466 0 0 0 2 9c0-1.61.476-3.11 1.295-4.365a.75.75 0 0 1 1.038-.219ZM10 6.12a3 3 0 0 0-3.001 3.041 11.455 11.455 0 0 1-2.697 7.24.75.75 0 0 1-1.148-.965A9.957 9.957 0 0 0 5.5 9c0-.028.002-.055.004-.082a4.5 4.5 0 0 1 8.996.084V9.15l-.005.297a.75.75 0 1 1-1.5-.034c.003-.11.004-.219.005-.328a3 3 0 0 0-3-2.965Zm0 2.13a.75.75 0 0 1 .75.75c0 3.51-1.187 6.745-3.181 9.323a.75.75 0 1 1-1.186-.918A13.687 13.687 0 0 0 9.25 9a.75.75 0 0 1 .75-.75Zm3.529 3.698a.75.75 0 0 1 .584.885 18.883 18.883 0 0 1-2.257 5.84.75.75 0 1 1-1.29-.764 17.386 17.386 0 0 0 2.078-5.377.75.75 0 0 1 .885-.584Z" clip-rule="evenodd" fill-rule="evenodd" /></svg>`
        },
        {
  ...
  <text x="12" y="12" text-anchor="middle" dominant-baseline="central" font-size="10" fill="currentColor">3</text>
    ...
    outcomes_data: {
      ...
      description: 'Members notice small wins—stronger movement, less joint discomfort, and wishing they’d started sooner.',
      articles: [
        {
          image: 'assets/outcome-1.jpg',
          date: 'Mar 16, 2020',
          datetime: '2020-03-16',
          category: 'Marketing',
          title: 'After 7 days',
    ...
    what_we_give_data: {
      ...
      description: 'The 3–20 Way offers older adults simple daily movements to improve strength and mobility at home in just 3 minutes a day helping change how we age.',
      features: [
        {
