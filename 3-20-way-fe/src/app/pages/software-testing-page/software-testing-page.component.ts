...
import { SoftwareTestingService } from '../../services/software-testing.service';
import { PricingSectionComponent } from '../../components/pricing-section/pricing-section.component';
import { CourseCurriculumComponent } from "../../components/course-curriculum/course-curriculum.component";

@Component({
  selector: 'app-software-testing-page',
  standalone: true,
  imports: [HeaderComponent, HeroSectionComponent, TestimonialsComponent, LanguageCtaComponent, CompaniesComponent, PricingSectionComponent, AdvancedCurriculumComponent, DownloadBrouchreCtaComponent, VideoTestimonialsComponent, FrequentlyAskedQuestionsComponent, TechnicalBenefitsComponent, BenefitsBeyondLearningComponent, WhoAreOurLearnersComponent, HaveMoreQuestionsComponent, MeetYourMentorsSectionComponent, WhatYouThinkYouNeedVsWhatYouActuallyNeedComponent, AboutUsComponent, FooterComponent, CourseCurriculumComponent],
  templateUrl: './software-testing-page.component.html',
})
export class SoftwareTestingPageComponent {
  color: any;
  constructor(public sts: SoftwareTestingService) { }
}
