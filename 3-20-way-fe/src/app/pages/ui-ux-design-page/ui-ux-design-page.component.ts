...
import { UiUxDesignService } from '../../services/ui-ux-design.service';
...
@Component({
  selector: 'app-ui-ux-design-page',
  imports: [HeaderComponent, HeroSectionComponent, TestimonialsComponent, LanguageCtaComponent, CompaniesComponent, PricingSectionComponent, AdvancedCurriculumComponent, DownloadBrouchreCtaComponent, VideoTestimonialsComponent, FrequentlyAskedQuestionsComponent, TechnicalBenefitsComponent, BenefitsBeyondLearningComponent, WhoAreOurLearnersComponent, HaveMoreQuestionsComponent, MeetYourMentorsSectionComponent, WhatYouThinkYouNeedVsWhatYouActuallyNeedComponent, FooterComponent, CourseCurriculumComponent],
  standalone: true,
  templateUrl: './ui-ux-design-page.component.html',
})
export class UiUxDesignPageComponent {
  color: any;
  constructor(public uxs: UiUxDesignService) { }
}
