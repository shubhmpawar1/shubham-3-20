...
import { NativeApplicationDevelopmentService } from '../../services/native-application-development.service';
...
@Component({
  selector: 'app-native-application-development-page',
  ...
  templateUrl: './native-application-development-page.component.html',
})
export class NativeApplicationDevelopmentPageComponent {

  constructor(public nads: NativeApplicationDevelopmentService) { };
}
